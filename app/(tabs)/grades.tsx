...
// Non-teacher users will be redirected to their own grade page
async function redirectBasedOnRole(user: any) {
    ...
    if (currentUser.isTeacher === false) {
        // If the user is a student, redirect to their own grade page
        router.push(`/Grades/${user.$id}`);
        return;
    }
}
// If the user is a teacher, stay on the main grades page to see the list of students
